...
const lastKnownEventId1 = fullTodoList1[fullTodoList1.length - 1].id;
...
const lastKnownEventId2 = fullTodoList2[0].id;
...
bench
  ...
  .add(
    ...
    async () => {
      await sorci.appendEventV2({
        ...
        lastKnownEventId: lastKnownEventId2
      });
    },
    {
      beforeAll: async () => {
  ...
  .add(
    ...
    async () => {
      await sorci.appendEventV2({
        ...
        queryV2: {
          $where: {
            todoListId: { $eq: todoList1Id }
          }
        },
        lastKnownEventId: lastKnownEventId1
      });
    },
    {
      beforeAll: async () => {
  ...
  .add(
    ...
    async () => {
      await sorci.getEventsByQuery({
        types: ["todo-list-created", "todo-list-renamed"],
        identifiers: [{ todoListId: todoList1Id }]
      });
    },
    {
